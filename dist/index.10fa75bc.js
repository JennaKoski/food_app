    ...
    API.get("jenna456").then((data)=>{
        ...
        if (data.documents) {
            data.documents.forEach((document)=>{
                ...
                totalProtein = Number(document.fields.protein.integerValue) + totalProtein;
                totalFat = Number(document.fields.fat.integerValue) + totalFat;
                let caloriesTotal = Number(totalCarbs) * 4 + Number(totalProtein) * 4 + Number(totalFat) * 9;
                totalCal.innerHTML = `${caloriesTotal}`;
            });
            chartTotal(totalCarbs, totalProtein, totalFat);
            foodSummary.innerHTML = data.documents.map((document)=>`<div class="summary"> <h3>${document.fields.foodSelection.stringValue}</h3>\n      <p> Total ${Number(document.fields.carbs.integerValue) * 4 + Number(document.fields.fat.integerValue) * 9 + Number(document.fields.protein.integerValue) * 4} kcal </p>\n      <div class="info">\n        <div class="carbsEnd">\n          <p>Carbs</p>\n          <p> ${document.fields.carbs.integerValue}g</p>\n        </div>\n        <div class="proteinEnd">\n          <p>Protein</p>\n          <p> ${document.fields.protein.integerValue}g</p>\n        </div>\n        <div class="fatEnd">\n          <p>Fat</p>\n          <p> ${document.fields.fat.integerValue}g</p>\n        </div>\n      </div>\n      </div>`
            ).join("");
        }
    });
};
const finale = (e)=>{
    ...
    if (foodSelection !== "Select your food" && carbs && protein && fat) {
        ...
        _snackbarDefault.default.show("😋");
    }
};
getFoods();
form.addEventListener("submit", finale);

},{"@parcel/transformer-js/src/esmodule-helpers.js":"JacNc","./fetch-wrapper":"gQ6Ql","snackbar":"60sYh","snackbar/dist/snackbar.min.css":"gJlwf","chart.js/auto":"f3sfP"}],"JacNc":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}]},["5MabY","g1M29"], "g1M29", "parcelRequire5b12")
